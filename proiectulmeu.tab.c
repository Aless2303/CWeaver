...
#line 702 "proiectulmeu.y"
  {
      (yyval.dval) = 0; // Valoare implicită pentru simbolul epsilon
  }
#line 1965 "proiectulmeu.tab.c"
    break;

  case 12: /* $@1: %empty  */
#line 708 "proiectulmeu.y"
               {
        enterScope();
    }
#line 1973 "proiectulmeu.tab.c"
    break;

  case 13: /* BlockStmt: TOK_LBRACE $@1 StmtList TOK_RBRACE  */
#line 710 "proiectulmeu.y"
                          {
        (yyval.dval) = (yyvsp[-1].dval);
        exitScope();
    }
#line 1982 "proiectulmeu.tab.c"
    break;

  case 14: /* FunctionDeclarationStmt: TOK_FUNCTION_BODY  */
#line 718 "proiectulmeu.y"
    {
        //printf("functie:\n%s\n\n\n",$1);
...
#line 2123 "proiectulmeu.tab.c"
    break;

  case 15: /* VariableList: TOK_VARIABLE  */
#line 863 "proiectulmeu.y"
                 {
        if(valoareif==-2)
...
#line 2148 "proiectulmeu.tab.c"
    break;

  case 16: /* VariableList: VariableList ',' TOK_VARIABLE  */
#line 883 "proiectulmeu.y"
                                  {
            if(valoareif==-2)
        {if (ts->exists((yyvsp[0].sir))) {
...
#line 2194 "proiectulmeu.tab.c"
    break;

  case 19: /* AmpersandVariable: '&' TOK_VARIABLE  */
#line 919 "proiectulmeu.y"
                     {
        if(valoareif==-2)
{        if (ts->exists((yyvsp[0].sir))) {
...
#line 1181 "proiectulmeu.y"
    {
        valoareif=-2;
    }
#line 2473 "proiectulmeu.tab.c"
    break;

  case 26: /* AuxIfFirst: %empty  */
#line 1187 "proiectulmeu.y"
    {
        if (valoareif==1)
            valoareif=-2;
        else if(valoareif!=2)
...
#line 2484 "proiectulmeu.tab.c"
    break;

  case 27: /* AuxIfSecond: %empty  */
#line 1196 "proiectulmeu.y"
    { 
        if (valoareif==2) 
            valoareif=-2;
        else if(valoareif!=1)
...
#line 2495 "proiectulmeu.tab.c"
    break;

  case 28: /* I: TOK_VARIABLE '=' E  */
#line 1205 "proiectulmeu.y"
                       {
    if(valoareif==-2){
        if (ts != NULL) {
...
#line 2549 "proiectulmeu.tab.c"
    break;

  case 29: /* I: TOK_INT TOK_VARIABLE  */
#line 1254 "proiectulmeu.y"
                         {
    if(valoareif==-2)
...
#line 2573 "proiectulmeu.tab.c"
    break;

  case 30: /* I: TOK_FLOAT TOK_VARIABLE  */
#line 1273 "proiectulmeu.y"
                           {
    if(valoareif==-2)
        {if (ts->exists((yyvsp[0].sir)) == 0) {
            if (tsStack.empty())
...
#line 2598 "proiectulmeu.tab.c"
    break;

  case 31: /* I: TOK_DOUBLE TOK_VARIABLE  */
#line 1293 "proiectulmeu.y"
                            {
    if(valoareif==-2)
        {if (ts->exists((yyvsp[0].sir)) == 0) {
            if (tsStack.empty())
...
#line 2621 "proiectulmeu.tab.c"
    break;

  case 32: /* I: TOK_PRINT TOK_VARIABLE  */
#line 1311 "proiectulmeu.y"
                           {
    if(valoareif==-2)
        {if (ts != NULL) {
...
#line 2679 "proiectulmeu.tab.c"
    break;

  case 33: /* I: TOK_DOUBLE TOK_VARIABLE '=' E  */
#line 1364 "proiectulmeu.y"
                                    {
        if(valoareif==-2)
...
#line 2706 "proiectulmeu.tab.c"
    break;

  case 34: /* I: TOK_INT TOK_VARIABLE '=' E  */
#line 1386 "proiectulmeu.y"
                                 {
        if(valoareif==-2)
        {if (ts->exists((yyvsp[-2].sir)) == 0) {
            if ((yyvsp[0].dval) < INT_MIN_LIMIT || (yyvsp[0].dval) > INT_MAX_LIMIT) {
...
#line 2733 "proiectulmeu.tab.c"
    break;

  case 35: /* I: TOK_FLOAT TOK_VARIABLE '=' E  */
#line 1408 "proiectulmeu.y"
                                   {
        if(valoareif==-2)
        {if (ts->exists((yyvsp[-2].sir)) == 0) {
            if ((yyvsp[0].dval) < FLOAT_MIN_LIMIT || (yyvsp[0].dval) > FLOAT_MAX_LIMIT) {
...
#line 2760 "proiectulmeu.tab.c"
    break;

  case 36: /* ReturnStmt: TOK_RETURN E ';'  */
#line 1432 "proiectulmeu.y"
                              {
...
#line 2770 "proiectulmeu.tab.c"
    break;

  case 37: /* E: TOK_VARIABLE  */
#line 1440 "proiectulmeu.y"
                 {
    if(valoareif==-2)
        {if (ts->exists((yyvsp[0].sir))) {
...
#line 2796 "proiectulmeu.tab.c"
    break;

  case 38: /* E: E TOK_PLUS E  */
#line 1461 "proiectulmeu.y"
                 { 
    if(valoareif==-2)
    {(yyval.dval) = (yyvsp[-2].dval) + (yyvsp[0].dval);} }
#line 2804 "proiectulmeu.tab.c"
    break;

  case 39: /* E: E TOK_MINUS E  */
#line 1464 "proiectulmeu.y"
                  { if(valoareif==-2)
  (yyval.dval) = (yyvsp[-2].dval) - (yyvsp[0].dval); }
#line 2811 "proiectulmeu.tab.c"
    break;

  case 40: /* E: E TOK_MULTIPLY E  */
#line 1466 "proiectulmeu.y"
                     { if(valoareif==-2)
  (yyval.dval) = (yyvsp[-2].dval) * (yyvsp[0].dval); }
#line 2818 "proiectulmeu.tab.c"
    break;

  case 41: /* E: E TOK_DIVIDE E  */
#line 1468 "proiectulmeu.y"
                   {
    if(valoareif==-2)
{        if ((yyvsp[0].dval) == 0) {
...
#line 2833 "proiectulmeu.tab.c"
    break;

  case 42: /* E: TOK_LEFT E TOK_RIGHT  */
#line 1478 "proiectulmeu.y"
                         { if(valoareif==-2)
  (yyval.dval) = (yyvsp[-1].dval); }
#line 2840 "proiectulmeu.tab.c"
    break;

  case 43: /* E: TOK_NUMBER_INT  */
#line 1480 "proiectulmeu.y"
                   { if(valoareif==-2)
  (yyval.dval) = (yyvsp[0].dval); }
#line 2847 "proiectulmeu.tab.c"
    break;

  case 44: /* E: TOK_NUMBER_FLOAT  */
#line 1482 "proiectulmeu.y"
                     { if(valoareif==-2)
  (yyval.dval) = (yyvsp[0].dval); }
#line 2854 "proiectulmeu.tab.c"
    break;

  case 45: /* E: TOK_NUMBER_DOUBLE  */
#line 1484 "proiectulmeu.y"
                      { if(valoareif==-2)
  (yyval.dval) = (yyvsp[0].dval); }
#line 2861 "proiectulmeu.tab.c"
    break;

  case 46: /* E: TOK_LEFT TOK_INT TOK_RIGHT TOK_VARIABLE  */
#line 1486 "proiectulmeu.y"
                                            {
    if(valoareif==-2)
    {if(ts->exists((yyvsp[0].sir)))
    {
...
#line 2884 "proiectulmeu.tab.c"
    break;

  case 47: /* E: TOK_LEFT TOK_DOUBLE TOK_RIGHT TOK_VARIABLE  */
#line 1504 "proiectulmeu.y"
                                               {
    if(valoareif==-2)
   { if(ts->exists((yyvsp[0].sir)))
    {
...
#line 2908 "proiectulmeu.tab.c"
    break;

  case 48: /* E: TOK_LEFT TOK_FLOAT TOK_RIGHT TOK_VARIABLE  */
#line 1523 "proiectulmeu.y"
                                              {
    if(valoareif==-2){
    if(ts->exists((yyvsp[0].sir)))
    {
...
#line 2961 "proiectulmeu.tab.c"
    break;

  case 50: /* ArgumentListFunctie: TOK_VARIABLE  */
#line 1570 "proiectulmeu.y"
    {
        if(valoareif==-2){
        if (ts->exists((yyvsp[0].sir))) {
...
#line 3156 "proiectulmeu.tab.c"
    break;

  case 60: /* LogicalExpression: E TOK_LT E  */
#line 1724 "proiectulmeu.y"
               {         
        (yyval.dval) = (yyvsp[-2].dval) > (yyvsp[0].dval); 
        if((yyvsp[-2].dval)>(yyvsp[0].dval))
            valoareif=1;
...
#line 3168 "proiectulmeu.tab.c"
    break;

  case 61: /* LogicalExpression: E TOK_EQ E  */
#line 1731 "proiectulmeu.y"
               {         
        (yyval.dval) = (yyvsp[-2].dval) == (yyvsp[0].dval); 
        if((yyvsp[-2].dval)==(yyvsp[0].dval))
            valoareif=1;
...
#line 3180 "proiectulmeu.tab.c"
    break;

  case 62: /* LogicalExpression: E TOK_GE E  */
#line 1738 "proiectulmeu.y"
               {        
        (yyval.dval) = (yyvsp[-2].dval) >= (yyvsp[0].dval); 
        if((yyvsp[-2].dval)>=(yyvsp[0].dval))
            valoareif=1;
...
#line 3192 "proiectulmeu.tab.c"
    break;

  case 63: /* LogicalExpression: E TOK_LE E  */
#line 1745 "proiectulmeu.y"
               {         
        (yyval.dval) = (yyvsp[-2].dval) <= (yyvsp[0].dval); 
        if((yyvsp[-2].dval)<=(yyvsp[0].dval))
            valoareif=1;
...
#line 3204 "proiectulmeu.tab.c"
    break;

  case 64: /* LogicalExpression: E TOK_NE E  */
#line 1752 "proiectulmeu.y"
               {         
        (yyval.dval) = (yyvsp[-2].dval) != (yyvsp[0].dval); 
        if((yyvsp[-2].dval)!=(yyvsp[0].dval))
            valoareif=1;
...
#line 3216 "proiectulmeu.tab.c"
    break;


#line 3220 "proiectulmeu.tab.c"
